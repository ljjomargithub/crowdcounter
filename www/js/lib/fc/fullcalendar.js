...
(function (factory) {
    ...
    function Header(calendar, options) {
        ...
        function render() {
            ...
            /* customer unitrak toolbar */
            var unitrak_users = '<div class="btn-group">' +
                '<select id="unitrak-calendar-users" onchange="jobfc.getusercalendar()" class="form-control" style=" width:250px; height:30px;">' +
                '</select>' +
                '</div>';
            tm = options.theme ? 'ui' : 'fc';
        ...
        function renderSection(position, extEl) {
    ...
    */
    ...
    $.extend(DayGrid.prototype, {
        ...
        renderSegHtml: function (seg, disableResizing) {
            ...
            titleHtml =
                '<span class="fc-title">' + event.location + '<br/>' +
            ...
            return '<a class="' + classes.join(' ') + '"' +
                ...
                '>' +
                    '<div class="fc-content" style= "background-color:' + _bgcolor + '; color:' + _color + '">' +
                        (isRTL ?
    ...
    $.extend(DayGrid.prototype, {
        ...
        renderMoreLink: function (cell, hiddenSegs) {
            ...
            return $('<a class="fc-more btn btn-danger"/>')
                .html(
                    this.getMoreLinkText(hiddenSegs.length) + '&nbsp;<i class="fa fa-chevron-down"></i>'
                )
    ...
    $.extend(TimeGrid.prototype, {
        ...
        renderSegHtml: function (seg, disableResizing) {
            ...
            return '<a class="' + classes.join(' ') + '"' +
                ...
                'style= "background-color:' + _bgcolor + '; color:' + _color + '">' +
                    '<div class="fc-content">' +
                        (timeText ?
                            ...
                            '>' +
                                '<span>' + htmlEscape(timeText) + '</span> ' + event.location + "<br/>" +
                            '</div>' :
                            ''
                            ) +
                        (event.title ?
