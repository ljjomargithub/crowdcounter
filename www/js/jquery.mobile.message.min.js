//jquery.mobile.message 1.8.2. Copyright (c) 2013 John Rummell (jrummell.com). Licensed under the GPL license  (http://www.gnu.org/licenses/gpl.html). 
...
var title=options.type.toUpperCase().substring(0,1)+options.type.substring(1);var messageHtml="<div class='message-container' data-collapsed='false' data-role='collapsible' data-theme='"+options.theme+"' data-content-theme='"+options.theme+"'>";messageHtml+="<h3>"+title+"<\/h3>";messageHtml+="<p><span class='message-text'>"+messageText+"</span>";if(options.dismiss)
{messageHtml+="<a class='message-dismiss' href='#'>Dismiss</a>";}
messageHtml+="</p></div>";$this.html(messageHtml);$this.find(".message-container").collapsible();if(options.dismiss)
...
{jQuery.error("Method "+method+" does not exist on jQuery.message");}};jQuery.fn.message.defaults={message:"",type:"info",theme:null,dismiss:true,autoShow:true};})(jQuery);